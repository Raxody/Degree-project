        ...
        <div class="container-fluid d-flex justify-content-center" >
                <div class="row col-lg-10 d-flex justify-content-center">
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" id="codigoMateria" name="codigoMateria"
                                value="<?php echo $codigoMateria?>">
                            <div class="centrarBoton">
                                <a class="btn btn-danger"
                                    href="./didacticasSegunProfesor.php?codigoMateria=<?php echo $codigoMateria;?>&codigoProfesor=<?php  echo $row['codigoProfesor'];?>">VER</a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="centrarBoton">
                        <a class="btn btn-danger"
                            href="./didacticasSegunMateria.php?codigoMateria=<?php echo $codigoMateria?>">VER</a>
